...
namespace NetworldSports\CustomOrderProcessing\Test\Unit\Model\ResourceModel\CustomOrderStatus;
...
/**
 * Custom Order Status Collection Test
 */
class CollectionTest extends TestCase
{
    ...
    public function testConstruct(): void
    {
        ...
        $this->assertEquals('status_id', $idFieldProperty->getValue($this->collection));

        $eventPrefixProperty = $reflection->getProperty('_eventPrefix');
        $eventPrefixProperty->setAccessible(true);
        $this->assertEquals('networldsports_custom_order_status_collection', $eventPrefixProperty->getValue($this->collection));

        $eventObjectProperty = $reflection->getProperty('_eventObject');
        $eventObjectProperty->setAccessible(true);
        $this->assertEquals('custom_order_status_collection', $eventObjectProperty->getValue($this->collection));
    }
    ...
    public function testModelResourceInitialization(): void
    {
        ...
        $this->assertEquals(CustomOrderStatus::class, $modelProperty->getValue($this->collection));
