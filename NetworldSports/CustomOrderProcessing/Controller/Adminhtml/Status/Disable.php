...
/**
 * Disable a custom order status
 */
class Disable extends Action implements HttpGetActionInterface, HttpPostActionInterface
{
    /** @see _isAllowed() */
    ...
    public function execute(): ResultInterface|ResponseInterface
    {
        ...
        if ($statusId) {
            try {
                ...
                $this->messageManager->addSuccessMessage(__('Status disabled.'));
                // Invalidate cache
